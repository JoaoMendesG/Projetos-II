...
namespace Instrucoes
{
    class Program
    {
        ...
        {
            if (args.Length == 0) // length é tamanho
            {
            ...
            {
                Console.WriteLine($"{args.Length} argumentos"); // strg interpolation $, 
            }
        }
        ...
        static void InstrucaoDo(string[] args)
        {
            ...
            do
            {
                texto = Console.ReadLine(); // famoso input, vai aguardar que o usuario passe um valor
                Console.WriteLine(texto);
            } while (!string.IsNullOrEmpty(texto)); // ! indica negacao, logo o cod fica: enquanto meu texto Ñ for nulo
        }
